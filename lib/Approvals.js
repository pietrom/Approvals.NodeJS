...
var verifyAndScrub = function (dirName, testName, data, scrubber, optionsOverride, fileExt) {
  ...
  if (data instanceof Buffer) {
    ...
    writer = new StringWriter(newOptions, data, fileExt);
  }
  verifyWithControl(namer, writer, null, newOptions);
};

var verify = function (dirName, testName, data, optionsOverride, fileExt) {
  return verifyAndScrub(dirName, testName, data, null, optionsOverride, fileExt);
};
